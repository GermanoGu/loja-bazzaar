...
export default function Home(){
  ...
  const populares = [
    {id:1, nome: 'Bolsa', preco:'R$49,90', imagem: 'https://m.media-amazon.com/images/I/51H+AVsys8S._AC_.jpg'},
    {id:2, nome: 'Casaco Masculino', preco:'R$89,90',imagem: 'https://a-static.mlcdn.com.br/800x560/blusa-moletom-slim-b39-jaqueta-casaco-moleton-masculino-vcstilo/vcstilo/651306856/9c950c1f656629857b90aaea8c353caa.jpg'},
    {id:3, nome: 'Touca', preco:'R$29,90',imagem: 'https://junkiesskateboard.com.br/wp-content/uploads/2021/07/touca-narina-rosa-junkies-skate-shop.jpg'}
  ...
  return(
    <ScrollView style={style.container}>
          ...
          <Text style={style.subtitle}>OS MAIS PEDIDOS</Text>
          <FlatList 
              data={populares}
          ...
          <View style={{flex: 1, marginBottom: 15}}>
             <Text style={style.subtitle}>MODA MASCULINA</Text>
